...
namespace Competitor.IoCConfig
{
    public static class ServiceCollectionExtensions
    {
        public static void AddCustomDataAccess(this IServiceCollection services, IConfiguration configuration)
        {
            services.AddDbContext<CompetitorContext>(config =>
            {
                config.UseSqlServer(
                    configuration.GetConnectionString("CompetitorConnectionString"),
            ...
            services.AddScoped<IUnitOfWork, CompetitorContext>();
        }
